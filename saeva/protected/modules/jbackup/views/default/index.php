...
<?php
    ...
    if($this->module->bootstrap){
        $cs->registerScript('backup','
            $(function (){
                $(".bdownload").html("<span class=\'glyphicon glyphicon-arrow-down\'></span>");
                $(".brestore").html("<span class=\'glyphicon glyphicon-repeat\'></span>");
            });
        ',CClientScript::POS_HEAD);
        $afterAjax = '$(".bdownload").html("<span class=\'glyphicon glyphicon-arrow-down\'></span>"); $(".brestore").html("<span class=\'glyphicon glyphicon-repeat\'></span>");';
    }else{
        $cs->registerScript('backup','
            $(function (){
                $(".download").text("");
                    ...
                    array(
                            ...
                            'buttons'=>array(
                                    ...
                                    'restore' => array(
                                        ...
                                        'options'=>array('class'=>$this->module->bootstrap ?'brestore':'restore','onClick'=>' return confirm("'.JBackupTranslator::t('backup', '¿Are you sure Restore Backup?').'")'),
